    ...
    <div style={styles.container}>
      <nav style={styles.navbar}>
        ...
        <div style={styles.navRight}>
          ...
          <span style={styles.badge}>RECEPTIONIST</span>
    ...
    <div>
      <div style={styles.banner}>
        ...
        <div>
          ...
          <p style={styles.bannerSub}>Reception Desk — Manage patient appointments and billing</p>
        </div>
      </div>
      <div style={styles.grid}>
        {[
          { key: 'appointments', icon: '📋', title: 'Manage Appointments', sub: 'View and manage all appointments' },
          { key: 'billing', icon: '🧾', title: 'Billing', sub: 'Create and manage patient bills' },
...
const styles = {
  ...
  navbar: { background: '#0F172A', padding: '0 32px', height: 64, display: 'flex', alignItems: 'center', justifyContent: 'space-between' },
  ...
  navLinkActive: { background: '#1E293B', border: 'none', color: '#F59E0B', padding: '8px 14px', borderRadius: 8, cursor: 'pointer', fontSize: 14, fontWeight: 600 },
  navRight: { display: 'flex', alignItems: 'center', gap: 12 },
  navName: { color: '#F1F5F9', fontSize: 14 },
  badge: { background: '#F59E0B', color: '#fff', padding: '4px 12px', borderRadius: 20, fontSize: 12, fontWeight: 700 },
  ...
  banner: { background: '#FFFBEB', border: '2px solid #F59E0B30', borderRadius: 16, padding: '28px 32px', marginBottom: 32, display: 'flex', alignItems: 'center', gap: 20 },
