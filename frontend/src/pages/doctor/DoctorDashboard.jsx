    ...
    <div style={styles.container}>
      <nav style={styles.navbar}>
        ...
        <div style={styles.navLinks}>
          <button style={activePage === 'home' ? styles.navLinkActive : styles.navLink}
            onClick={() => setActivePage('home')}>Home</button>
          <button style={activePage === 'appointments' ? styles.navLinkActive : styles.navLink}
            onClick={() => setActivePage('appointments')}>My Appointments</button>
        </div>
    ...
    <div>
      <div style={styles.banner}>
        ...
        <div>
          ...
          <p style={styles.bannerSub}>Doctor Dashboard — Manage your patients and appointments</p>
        </div>
      </div>
      ...
      <div style={styles.grid}>
        <div style={styles.card} onClick={() => setActivePage('appointments')}>
          ...
          <p style={styles.cardSub}>View and manage patient appointments</p>
        </div>
        <div style={styles.card}>
          <span style={styles.cardIcon}>👥</span>
          <h3 style={styles.cardTitle}>My Patients</h3>
          <p style={styles.cardSub}>Coming in Phase 3</p>
        </div>
        <div style={styles.card}>
          <span style={styles.cardIcon}>📝</span>
          <h3 style={styles.cardTitle}>Medical Notes</h3>
          <p style={styles.cardSub}>Coming in Phase 3</p>
        </div>
      </div>
    </div>
...
const styles = {
  ...
  navLinkActive: {
    background: '#1E293B', border: 'none', color: '#8B5CF6',
  ...
  banner: {
    background: '#F5F3FF', border: '2px solid #8B5CF630', borderRadius: 16,
